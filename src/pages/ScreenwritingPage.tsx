...
const prose: ProseStory[] = [
  { title: 'Exiiogist Expedition', year: '2022', genre: 'Sci-Fi, Horror, Thriller', cover: '/images/prose/exiiogist-expedition-bart.webp', pdf: '/scripts/exiiogist-expedition.pdf', text: 'A stranded exiiologist on a frozen alien world is being hunted by a relentless presence. As isolation and exhaustion blur reality, his fight for survival leads him toward a fragile hope of rescue. But on a planet where the past refuses to stay dead, the thing chasing him may be far more familiar than he dares to believe.', link: { label: 'Check out the Audiobook', href: 'https://youtu.be/HvNr29Bi7iE' } },
  { title: 'Bluffing in Derado', year: '2023', genre: 'Sci-Fi, Drama, Crime', cover: '/images/prose/bluffing-in-derado-bart.webp', pdf: '/scripts/bluffing-in-derado.pdf', text: 'A washed-up poker legend with a galaxy-wide reputation wakes up buried in debt, hunted by dangerous creditors, and drifting through a neon gambling world where lives are wagered as easily as money. But as the pressure closes in, he realizes losing everything might not be the thing he fears most.' },
  { title: 'Home for Christmas', year: '2023', genre: 'Sci-Fi, Action, Thriller', cover: '/images/prose/home-for-christmas-bart.webp', pdf: '/scripts/home-for-christmas.pdf', text: "On Christmas Eve, a hardened bounty hunter is sent to capture a brilliant fugitive hiding on a remote prison planet, but in turn uncovers a truth that shatters everything he believes about himself. As the hunt spirals into a deadly game of identity and survival, he's forced to question whether escaping the prison was ever the real crime." },
  { title: 'Red Pastures', year: '2023', genre: 'Sci-Fi, Drama, Horror', cover: '/images/prose/red-pastures-bart.webp', pdf: '/scripts/red-pastures.pdf', text: '"Me and my family love living off the land, But I never expected the land living off us." A young girl experiences farm life on an extraterrestrial planet and learns the beauty, and the horror of futuristic agriculture.' },
  { title: 'Space Race 2: USA vs China', year: '2023', genre: 'Soft Sci-Fi, Comedy', cover: '/images/prose/space-race-2-bart.webp', pdf: '/scripts/space-race-2.pdf', text: "The U.S. have found themselves back into a space race, but this time it's with China, and they go above and beyond to beat them..." },
  { title: 'Window to the Stars', year: '2023', genre: 'Sci-Fi, Fantasy, Drama', cover: '/images/prose/window-to-the-stars-bart.webp', pdf: '/scripts/window-to-the-stars.pdf', text: 'A woman wakes up in her childhood home, but when she looks through her window, all she can see is the vastness of space above, around, and below.' },
];
